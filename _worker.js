...
let urls = [];
let subconverter = "psub.antyi.us.kg"; //在线订阅转换后端，目前使用CM的订阅转换功能。支持自建psub 可自行搭建https://github.com/bulianglin/psub
let subconfig = "https://raw.githubusercontent.com/jormmyant/rule/refs/heads/main/rule.ini"; //订阅配置文件
